            ...
            try:
                ...
                response_step2 = client.models.generate_content(
                    ...
                    config=types.GenerateContentConfig(
                        ...
                        - 時事、スポーツ、流行、ファッション、コスメ、食事、デートスポット、ショッピング、通販、芸能、ゲーム、映画、Youtube、TikTok、Instagram、数学、政治、経済、地理、歴史、英語、化学、科学、物理、力学、生物、古文、現代文、音楽、保健、体育、技術、家庭科、美術の分野において、優秀なコンシュルジュマスターでもあります。
